...
b = drag_cannon(flight_state(0, 0, 1000*cos(pi*30/180), 1000*sin(pi*30/180), 0), _dt = 0.1)
b.shoot()
b.show_trajectory()
...
a.shoot()
a.show_trajectory()
plot(x,y,color='orange',label=r'$\theta=35^\circ$')
legend(loc='best',prop={'size':11},frameon=False)
a_final=x[-1]

b = drag_cannon(flight_state(0, 0, 1000*cos(pi*35/180), 1000*sin(pi*35/180), 0), _dt = 0.1)
b.shoot()
b.show_trajectory()
plot(x,y,color='black',label = r'$drag\theta=35^\circ$')
legend(loc = 'best', prop = {'size':11}, frameon = False)
b_final = x[-1]
...
b = drag_cannon(flight_state(0, 0, 1000*cos(pi*40/180), 1000*sin(pi*40/180), 0), _dt = 0.1)
b.shoot()
b.show_trajectory()
...
b = drag_cannon(flight_state(0, 0, 1000*cos(pi*45/180), 1000*sin(pi*45/180), 0), _dt = 0.1)
b.shoot()
b.show_trajectory()
plot(x,y,'g--', label = r'$drag\theta=45^\circ$')
legend(loc = 'best', prop = {'size':11}, frameon = False)
b_final = x[-1]
...
a.shoot()
a.show_trajectory()
plot(x,y,'b',label=r'$\theta=50^\circ$')
legend(loc='best',prop={'size':11},frameon=False)
a_final=x[-1]

b = drag_cannon(flight_state(0, 0, 1000*cos(pi*50/180), 1000*sin(pi*50/180), 0), _dt = 0.1)
b.shoot()
b.show_trajectory()
plot(x,y,'b--', label = r'$drag\theta=50^\circ$')
legend(loc = 'best', prop = {'size':11}, frameon = False)
b_final = x[-1]
...
a.shoot()
a.show_trajectory()
plot(x,y,color='c',label=r'$\theta=55^\circ$')
legend(loc='best',prop={'size':11},frameon=False)
a_final=x[-1]

b = drag_cannon(flight_state(0, 0, 1000*cos(pi*55/180), 1000*sin(pi*55/180), 0), _dt = 0.1)
b.shoot()
b.show_trajectory()
plot(x,y,'c--', label = r'$drag\theta=55^\circ$')
legend(loc = 'best', prop = {'size':11}, frameon = False)
b_final = x[-1]
...
b = drag_cannon(flight_state(0, 0, 1000*cos(pi*60/180), 1000*sin(pi*60/180), 0), _dt = 0.1)
b.shoot()
b.show_trajectory()
