...
a = drag_cannon2(flight_state(0, 0, 1000*cos(pi*45/180), 1000*sin(pi*45/180), 0), _dt = 0.1)
a.shoot()
a.show_trajectory()
...
c = drag_cannon3(flight_state(0, 0, 1000*cos(pi*45/180), 1000*sin(pi*45/180), 0), _dt = 0.1)
c.shoot()
c.show_trajectory()
...
d = drag_cannon4(flight_state(0, 0, 1000*cos(pi*45/180), 1000*sin(pi*45/180), 0), _dt = 0.1)
d.shoot()
d.show_trajectory()
...
e = drag_cannon5(flight_state(0, 0, 1000*cos(pi*45/180), 1000*sin(pi*45/180), 0), _dt = 0.1)
e.shoot()
e.show_trajectory()
...
f = drag_cannon10(flight_state(0, 0, 1000*cos(pi*45/180), 1000*sin(pi*45/180), 0), _dt = 0.1)
f.shoot()
f.show_trajectory()
...
h = drag_cannon10(flight_state(0, 0, 1000*cos(pi*45/180), 1000*sin(pi*45/180), 0), _dt = 0.1)
h.shoot()
h.show_trajectory()
...
text(48000,18000,r'$\theta=45^\circ$')
