# -*- coding: utf-8 -*-
"""
Created on Fri Jun 17 08:28:56 2016
...
c = isothermal_drag_cannon(flight_state(0, 0, 1000*cos(pi*45/180), 1000*sin(pi*45/180), 0), _dt = 0.1)
c.shoot()
c.show_trajectory()
...
d = adiabatic_drag_cannon(flight_state(0, 0, 1000*cos(pi*45/180), 1000*sin(pi*45/180), 0), _dt = 0.1)
d.shoot()
d.show_trajectory()
