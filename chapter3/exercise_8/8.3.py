# -*- coding: utf-8 -*-
"""
Created on Mon Jun 20 20:50:36 2016
...
A=driven_pendulum(0,10*math.pi/180,0.01,20,0,1.0,0.4,1)
B=driven_pendulum(0,10*math.pi/180,0.01,20,0,1.0,0.4,2)
C=driven_pendulum(0,10*math.pi/180,0.01,20,0,1.0,0.4,3)
A.calculate()
B.calculate()
C.calculate()
